...
import com.daikuanchaoshi.daikuanguowai.ui.utils.MyWebViewClient;
...
import static com.daikuanchaoshi.daikuanguowai.ui.utils.MyChromeClient.FILECHOOSER_RESULTCODE;

public class Act_MyKeFu extends BaseAct implements MyWebViewClient.backWebviewStatus {
    ...
    Dlg_Photograph photograph;
    private ValueCallback<Uri> mUploadMessage;// 表单的数据信息
    private ValueCallback<Uri[]> mUploadCallbackAboveL;

    @Override
    public void initData() {
        mWebView.loadUrl(url + "?token=" + MyApplication.getLognBean().getMember().getToken());
        ...
        mWebView.setWebViewClient(new MyWebViewClient(mWebView, this, Act_MyKeFu.this));
        //拍照相册回调
